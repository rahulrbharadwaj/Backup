...
N 1780 -640 1780 -610 { lab=#net9}
N 1780 -640 1870 -640 { lab=#net9}
N 1850 -620 1850 -530 { lab=#net10}
N 1850 -620 1870 -620 { lab=#net10}
N 1830 -410 1830 -380 { lab=#net11}
N 1830 -410 1920 -410 { lab=#net11}
N 1900 -390 1900 -300 { lab=#net12}
N 1900 -390 1920 -390 { lab=#net12}
N 2520 -680 2520 -650 { lab=#net13}
N 2520 -680 2610 -680 { lab=#net13}
N 2590 -660 2590 -570 { lab=#net14}
N 2590 -660 2610 -660 { lab=#net14}
N 2570 -450 2570 -420 { lab=#net15}
N 2570 -450 2660 -450 { lab=#net15}
N 2640 -430 2640 -340 { lab=#net16}
N 2640 -430 2660 -430 { lab=#net16}
...
N 1520 -550 1550 -550 { lab=#net6}
N 1550 -550 1600 -550 { lab=#net6}
N 1600 -550 1640 -550 { lab=#net6}
...
C {isource.sym} 1940 -960 1 0 {name=I0 value="sin(0 0.1u 250k 0 0 0)"}
C {lab_pin.sym} 1910 -960 0 0 {name=l22 sig_type=std_logic lab=b}
C {lab_pin.sym} 1970 -960 2 0 {name=l23 sig_type=std_logic lab=a}
C {capa.sym} 1630 -520 0 0 {name=C1
m=1
value=1p
footprint=1206
device="ceramic capacitor"}
C {vsource.sym} 1630 -460 0 1 {name=V1 value=1.8}
C {gnd.sym} 1630 -430 0 1 {name=l51 lab=GND}
